...
//define('ABS_PATH','/home/greygler/greygler.pro/drop'); //  Абсолютный путь на сервере
...
define('TITLE','DropServicePlus'); // Метатег title
define('DESCRIPTION','Система Управления Продажами по Дропшиппингу DropServicePlus v.1.0.'); // Метатег description
define('KEYWORDS','Дропшиппинг'); // Метатег keywords
...
define('UPDATE_PATH',SITE_ADDR.'/update'); // Абсолютный путь для обновлений
...
define('ADDRESS_LINK','#'); // Ссылка на сайт предпиятия
define('MIN_PAY','100'); // Минимальная сумма выплат дроперам
...
define('UPDATE_USER', 1); // Обновление профиля пользователя, мин
define('NOTI', 7); // Время активности окна уведомлений, сек

define('TELEGRAM_BOT','430772242:AAGKHaULt4I8fVYVUD3mekEFktl7xYwh1hw'); // Токен Телеграмм-бота
define('TELEGRAM_BOT_NAME','mydrop_bot'); // Имя телеграм-бота
